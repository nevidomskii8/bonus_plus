...
const MovieTypes = () => {
  ...
  return (
    <div className={`movies-types focusable ${focusSection === "movies-types" ? "focused" : ""}`}>
      ...
      <ul>
        <li className={`movies-types__list collections ${currentChoose === "collections" && isActive ? "active" : ""}`}>
          {/* <FormattedMessage id="app.tv.funny" /> */}
          Коллекции
        </li>
        <li className={`movies-types__list shows ${currentChoose === "shows" && isActive ? "active" : ""}`}>
          Развлекательные шоу
          {/* <FormattedMessage id="app.tv.sports" /> */}
        </li>
        <li className={`movies-types__list musical ${currentChoose === "musical" && isActive ? "active" : ""}`}>
          Музыкальные
          {/* <FormattedMessage id="app.tv.childrens" /> */}
        </li>
        <li className={`movies-types__list movies ${currentChoose === "movies" && isActive ? "active" : ""}`}>
          Мультфильмы
          {/* <FormattedMessage id="app.tv.educational" /> */}
        </li>
        <li className={`movies-types__list debts ${currentChoose === "debts" && isActive ? "active" : ""}`}>
          Отложеные
          {/* <FormattedMessage id="app.tv.musical" /> */}
        </li>
        <li className={`movies-types__list foun ${currentChoose === "foun" && isActive ? "active" : ""}`}>
          Поиск
