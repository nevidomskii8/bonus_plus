...
const ChanalGanres = () => {
  ...
  return (
    <div
      className={`list-genres focusable ${
        focusSection === 'list-genres' ? 'focused' : ''
      }`}
    >
      <center>
        <h2>Телевидение</h2>
      ...
      <ul>
        <li
          className={`tv-page_list 7 ${
            currentChoose === '7' && isActive ? 'active' : ''
          }`}
        >
          <FormattedMessage id="app.tv.funny" />
        </li>
        <li
          className={`tv-page_list 3 ${
            currentChoose === '3' && isActive ? 'active' : ''
          }`}
        >
          <FormattedMessage id="app.tv.sports" />
        </li>
        <li
          className={`tv-page_list 4 ${
            currentChoose === '4' && isActive ? 'active' : ''
          }`}
        >
          <FormattedMessage id="app.tv.childrens" />
        </li>
        <li
          className={`tv-page_list 5 ${
            currentChoose === '5' && isActive ? 'active' : ''
          }`}
        >
          <FormattedMessage id="app.tv.educational" />
        </li>
        <li
          className={`tv-page_list 6 ${
            currentChoose === '6' && isActive ? 'active' : ''
          }`}
        >
          <FormattedMessage id="app.tv.musical" />
        </li>
        <li
          className={`tv-page_list 8 ${
            currentChoose === '8' && isActive ? 'active' : ''
          }`}
        >
          <FormattedMessage id="app.tv.movies" />
        </li>
        <li
          className={`tv-page_list 10 ${
            currentChoose === '10' && isActive ? 'active' : ''
          }`}
        >
          <FormattedMessage id="app.tv.news" />
        </li>
        <li
          className={`tv-page_list 9 ${
            currentChoose === '9' && isActive ? 'active' : ''
          }`}
        >
          HD
        </li>
        ...
        <li
          className={`tv-page_list home ${
            currentChoose === 'home' && isActive ? 'active' : ''
          }`}
        >
          Домашние
        </li>
