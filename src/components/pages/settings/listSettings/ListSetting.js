  ...
  return (
    <div className={`setting focusable ${focusSection === "setting" && isActive ? "focused" : ""}`}>
      ...
      <ul>
        ...
        <li
          className={`menu_item time_area right_click ${currentChoose === "time_area" && isActive ? "active" : ""}  `}
        >
        ...
        <li
          className={`menu_item info_video right_click ${currentChoose === "info_video" && isActive ? "active" : ""} `}
        >
