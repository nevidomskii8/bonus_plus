  ...
  return (
    ...
    >
      ...
      <ul className={`navigation__menu`}>
        <li
          className={`navigation__item-nav tv ${
            currentChoose === 'tv' && isActive ? 'active' : ''
          }`}
        >
        ...
        <li
          className={`navigation__item-nav movie-types ${
            currentChoose === 'movie-types' && isActive ? 'active' : ''
          }`}
        >
        ...
        <li
          className={`navigation__item-nav serialize ${
            currentChoose === 'serialize' && isActive ? 'active' : ''
          }`}
        >
        ...
        <li
          className={`navigation__item-nav setup ${
            currentChoose === 'setup' && isActive ? 'active' : ''
          }`}
        >
        ...
        <li
          className={`navigation__item-nav paycard ${
            currentChoose === 'paycard' && isActive ? 'active' : ''
          }`}
        >
        ...
        <li
          className={`navigation__item-nav youtube ${
            currentChoose === 'youtube' && isActive ? 'active' : ''
          }`}
        >
        ...
        <li
          className={`navigation__item-nav radio ${
            currentChoose === 'radio' && isActive ? 'active' : ''
          }`}
        >
